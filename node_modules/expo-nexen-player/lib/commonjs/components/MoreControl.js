...
const MoreControl = props => {
  ...
  const [moreItems, setMoreItems] = _react.default.useState([]);
  ...
  _react.default.useEffect(() => {
    const MORE_ITEMS = [{
      ...
      id: 'reload',
      icon: /*#__PURE__*/_react.default.createElement(_icons.IconReload, {
        size: ICON_SIZE,
        color: ICON_COLOR
      }),
      label: 'Reload Video'
    ...
    if (!disablePlaylistAndSkip && !(playerConfig !== null && playerConfig !== void 0 && playerConfig.disablePlayList)) {
      MORE_ITEMS.splice(3, 0, {
        id: 'playlist',
        icon: /*#__PURE__*/_react.default.createElement(_icons.IconFilm, {
          size: ICON_SIZE,
          color: ICON_COLOR
        }),
  ...
  const renderMoreItem = _ref => {
    ...
    }, item.icon, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
...
var _default = (0, _withAnimation.withAnimation)(MoreControl);
