...
var _StepSeekBar = _interopRequireDefault(require("./StepSeekBar"));

var _ModalView = _interopRequireDefault(require("./ModalView"));

var _withAnimation = require("../hoc/withAnimation");
...
const SpeedControl = props => {
  ...
  const stepSeekBarTheme = _react.default.useMemo(() => {
    ...
    return {
      ...
      lineColor: (nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$speedSeek = nexenTheme.speedSeekBar) === null || _nexenTheme$speedSeek === void 0 ? void 0 : _nexenTheme$speedSeek.lineColor) || (0, _ColorUtil.getAlphaColor)(nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$colors = nexenTheme.colors) === null || _nexenTheme$colors === void 0 ? void 0 : _nexenTheme$colors.accentColor, 0.7),
  ...
  }, /*#__PURE__*/_react.default.createElement(_StepSeekBar.default, {
...
var _default = (0, _withAnimation.withAnimation)(SpeedControl);
