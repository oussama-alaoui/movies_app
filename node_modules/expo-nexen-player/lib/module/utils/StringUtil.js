...
export const getAspectRatioTipText = text => {
...
export const getTimeTipText = (time, totalTime) => {
...
export const getForwardOrRewindTimeTipText = (symbol, minTime, maxTime) => {
  return `${symbol}${formatTimeTip(minTime)} (${formatTimeTip(maxTime)})`;
};
export const getForOrRewTimeTipText = (symbol, forwardTime, time) => {
