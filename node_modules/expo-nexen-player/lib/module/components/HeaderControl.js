...
import { Animated, I18nManager, StyleSheet, Text, TouchableHighlight, View } from 'react-native';
import { IconAspectRatio, IconChevronLeft, IconMoreHorizontal } from '../assets/icons';
import IconButton from './IconButton';
import GradientView from './GradientView';
import IconTagView from './IconTagView';
import { getAlphaColor } from '../utils/ColorUtil';
const HeaderControl = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const iconTagViewTheme = React.useMemo(() => {
    ...
    return {
      ...
      activeIconColor: (nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$tagView8 = nexenTheme.tagView) === null || _nexenTheme$tagView8 === void 0 ? void 0 : _nexenTheme$tagView8.activeIconColor) || getAlphaColor(nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$colors4 = nexenTheme.colors) === null || _nexenTheme$colors4 === void 0 ? void 0 : _nexenTheme$colors4.accentColor, 0.7),
      inactiveIconColor: (nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$tagView9 = nexenTheme.tagView) === null || _nexenTheme$tagView9 === void 0 ? void 0 : _nexenTheme$tagView9.inactiveIconColor) || getAlphaColor(nexenTheme === null || nexenTheme === void 0 ? void 0 : (_nexenTheme$colors5 = nexenTheme.colors) === null || _nexenTheme$colors5 === void 0 ? void 0 : _nexenTheme$colors5.primaryColor, 0.5),
  ...
  return /*#__PURE__*/React.createElement(Animated.View, {
  ...
  }, !locked && !(playerConfig !== null && playerConfig !== void 0 && playerConfig.disableBack) && /*#__PURE__*/React.createElement(IconButton, {
    style: {
      transform: [{
        scaleX: isRTL ? -1 : 1
      }]
    ...
    numberOfLines: 2
  }, title === null || title === void 0 ? void 0 : title.toUpperCase())), /*#__PURE__*/React.createElement(View, {
    style: [styles.iconButtonContainer]
  }, !locked && (playerConfig === null || playerConfig === void 0 ? void 0 : playerConfig.layoutMode) === 'advanced' && /*#__PURE__*/React.createElement(IconTagView, {
    ref: iconTagViewRef,
    style: {
      marginHorizontal: 4
    },
    theme: iconTagViewTheme
  }), !locked && !(playerConfig !== null && playerConfig !== void 0 && playerConfig.disableResizeMode) && (playerConfig === null || playerConfig === void 0 ? void 0 : playerConfig.layoutMode) === 'intermediate' && /*#__PURE__*/React.createElement(IconButton, {
    onPress: onAspectRatioPress
  }, /*#__PURE__*/React.createElement(IconAspectRatio, {
    size: ICON_SIZE,
    color: ICON_COLOR
  })), !locked && !(playerConfig !== null && playerConfig !== void 0 && playerConfig.disableMore) && (playerConfig === null || playerConfig === void 0 ? void 0 : playerConfig.layoutMode) === 'advanced' && /*#__PURE__*/React.createElement(IconButton, {
    onPress: onMorePress
...
export default /*#__PURE__*/React.memo(HeaderControl);
